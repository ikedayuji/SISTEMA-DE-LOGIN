...
class App(ctk.CTk):
    ...
    def tela_de_login(self):
        ...
        self.username_login_entry = ctk.CTkEntry(self.frame_login, width=30, font=("Century Gothic bold", 16))
        self.username_login_entry.grid(row=1, column=0, pady=10, padx=10)
  
        self.senha_login_entry = ctk.CTkEntry(self.frame_login, width=30, font=("Century Gothic bold", 16))
