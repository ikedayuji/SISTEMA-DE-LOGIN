...
class App(ctk.CTk):
    ...
    def tela_de_login(self):
        ...
        self.img = PhotoImage(file="logi-img.png")
        ...
        self.username_login_entry = ctk.CTkEntry(self.frame_login, width=30, placeholder="Seu nome de usuario...", font=("Century Gothic bold", 16))
        self.username_login_entry.grid(row=1, column=0, pady=10, padx=10)
  
        self.senha_login_entry = ctk.CTkEntry(self.frame_login, width=30, placeholder="Sua senha...", font=("Century Gothic bold", 16))
        self.senha_login_entry.grid(row=2, column=0, pady=10, padx=10)
    
        self.ver_senha = ctk.CTkCheckBox(self.frame_login, text="Clique para ver a senha", font=("Century Gothic bold", 12))
        self.ver_senha.grid(row=3, column=0, pady=10, padx=10)
        
        self.btn_login = ctk.CTkButton(self.frame_login, width=30, text="Fazer Login".upper(), font=("Century Gothic bold", 16))
        self.btn_login.grid(row=4, column=0, pady=10, padx=10)
        
        self.span = ctk.CTkLabel(self.frame_login, text="Se você não tem conta, clique no botão abaixo para cadastrar!", font=("Century Gothic", 10))
